...
class LearningConfig(BaseModel):
    ...
    enabled: bool = Field(default=False, description="Enable neural fusion")
    fusion_model_path: str | None = Field(default=None, description="Path to torch state_dict")
    max_offset_delta_ns: float = Field(default=1e6, description="Max delta vs heuristic (ns)")
    min_variance: float = Field(default=1e-18, description="Minimum allowed variance")
    max_variance: float = Field(default=1e-6, description="Maximum allowed variance")
